...
public class ApacheParquetWriteSupport extends WriteSupport<ApacheAccessLog> {
        MessageType schema;
        RecordConsumer recordConsumer;
        List<ColumnDescriptor> cols;

        // TODO: support specifying encodings and compression
        ApacheParquetWriteSupport(MessageType schema) {
            this.schema = schema;
        ...
        private void writeField(String val, int i) {
            if (val.length() > 0) {
